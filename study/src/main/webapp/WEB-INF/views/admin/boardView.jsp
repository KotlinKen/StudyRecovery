...
<div class="form-row">
	...
	<form action="${rootPath }/admin/replyWrite" method="post" class="form-inline">
...
function fn_replyView(tr, rno){

	$tr = $(tr);
	
	console.log($tr);
	
	//$("<tr><td>1</td><td>1</td><td>1</td><td>1</td><td>1</td></tr>").insertAfter($tr);
